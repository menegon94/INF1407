...
function mudarEstado() {
    ...
    if (state == 4) {
        ...
        J1.src = arr1[0] ? "Images/moeda_cara.jpg" : "Images/moeda_coroa.jpg";
        let J2 = document.getElementById("S4Jogada2");
        J2.src = arr1[1] ? "Images/moeda_cara.jpg" : "Images/moeda_coroa.jpg";
        let J3 = document.getElementById("S4Jogada3");
        J3.src = arr1[2] ? "Images/moeda_cara.jpg" : "Images/moeda_coroa.jpg";
        let JC1 = document.getElementById("S4JogadaC1");
        JC1.src = arr2[0] ? "Images/moeda_cara.jpg" : "Images/moeda_coroa.jpg";
        let JC2 = document.getElementById("S4JogadaC2");
        JC2.src = arr2[1] ? "Images/moeda_cara.jpg" : "Images/moeda_coroa.jpg";
        let JC3 = document.getElementById("S4JogadaC3");
        JC3.src = arr2[2] ? "Images/moeda_cara.jpg" : "Images/moeda_coroa.jpg";
    }
...
function checaJogada(array) {
    if (array.length < 3) {
        if (arrgame[0] != null) {
            ...
            JG1.src = arrgame[0] ? "Images/moeda_cara.jpg" : "Images/moeda_coroa.jpg";
        }
        if (arrgame[1] != null) {
            let JG2 = document.getElementById("S4JogadaG2");
            JG2.src = arrgame[1] ? "Images/moeda_cara.jpg" : "Images/moeda_coroa.jpg";
        }
        if (arrgame[2] != null) {
            let JG3 = document.getElementById("S4JogadaG3");
            JG3.src = arrgame[2] ? "Images/moeda_cara.jpg" : "Images/moeda_coroa.jpg";
        }
    }
    else {
        ...
        if (arrgame[0] != null) {
            let JG1 = document.getElementById("S4JogadaG1");
            JG1.src = fatia[0] ? "Images/moeda_cara.jpg" : "Images/moeda_coroa.jpg";
        }
        if (arrgame[1] != null) {
            let JG2 = document.getElementById("S4JogadaG2");
            JG2.src = fatia[1] ? "Images/moeda_cara.jpg" : "Images/moeda_coroa.jpg";
        }
        if (arrgame[2] != null) {
            let JG3 = document.getElementById("S4JogadaG3");
            JG3.src = fatia[2] ? "Images/moeda_cara.jpg" : "Images/moeda_coroa.jpg";
        }
